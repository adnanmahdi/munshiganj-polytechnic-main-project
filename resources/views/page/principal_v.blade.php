...
?>
        <div class="all_cmt" style="margin: auto;">
             ...
             <h1>Messages from Vice Principall</h1>
         </div>
           @foreach($all_vprincipal_info as $v_pricipal )
         <div class="cmt_img" style="float: left;">
             <img src="{{URL::to($v_pricipal->vprincipal_image)}}" style="margin: 10px 20px; height: 270px; width: 330px;border: 4px solid gray; border-style: double;">
         </div>
         <div class="content_cmt" style="margin-left: 1%;">
           
           <p>
{{$v_pricipal->add_vprincipal}}</p>
