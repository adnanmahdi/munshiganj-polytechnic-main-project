...
<div class="row sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="{{url('/input_student')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="student_father_name" required>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="date01">Student,s mother name</label>
                        <div class="controls">
                            <input type="text" name="student_mother_name" required>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="date01">Student,s session</label>
                        <div class="controls">
                            <input type="text" name="student_session" required>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="student_rool" required>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="fileInput">student,s photo</label>
                        <div class="controls">
                            <input class="input-file uniform_on" id="fileInput" name="student_photo" type="file" required>
                        </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" id="textarea2" rows="3" name="student_address" required></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xlarge datepicker" id="date01" value="02/16/12" name="student_admissionyear" required>
                        </div>
                    </div>
