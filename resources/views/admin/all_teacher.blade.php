            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center"><img src="{{URL::to($v_teacher->teacher_photo)}}" style="height:80px; width:70px; " </td> <td class="center">{{$v_teacher->teacher_address}}</td>
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-info" href="{{URL::to('/edit_teachers/'.$v_teacher->teacher_id)}}">
